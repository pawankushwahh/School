      ...
      <footer className="bg-accent text-white py-8">
        <div className="container mx-auto px-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span>AB Road, Dultaria, Pachore, Rajgarh, MP – 465683</span>
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>info@santoshmittalschool.edu.in</span>
                </li>
              </ul>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-accent-light text-center">
            <p>&copy; {new Date().getFullYear()} Prof. Santosh Mittal Higher Secondary School. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>

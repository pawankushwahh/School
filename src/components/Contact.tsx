        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="bg-white rounded-2xl shadow-xl p-8 transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-gray-600">AB Road, Dultaria, Pachore, Rajgarh, MP – 465683</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@santoshmittalschool.edu.in</p>
                  <p className="text-gray-600">admissions@santoshmittalschool.edu.in</p>
                </div>
              </div>
            ...
            <div className="mt-8 rounded-xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14682.146627788367!2d76.71666556977537!3d23.089645799999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397ce9c8c62c5d91%3A0x7c304fe47092292e!2sPachore%2C%20Madhya%20Pradesh%20465683!5e0!3m2!1sen!2sin!4v1710835367411!5m2!1sen!2sin"
                width="100%"
                height="300"
                style={{ border: 0 }}
                allowFullScreen
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <a
                  href="mailto:info@santoshmittalschool.edu.in"
                  className="flex items-center justify-center gap-2 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
                >
